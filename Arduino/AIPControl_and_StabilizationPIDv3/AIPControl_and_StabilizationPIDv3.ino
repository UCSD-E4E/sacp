...
AIPControl_and_StabilizationPIDv3
 ...
 Version 3 uses PID controllers for roll, pitch and yaw stabilization, and commands have been
 changed to use a WASD steering control interface.
